...
Terragrunt is a thin wrapper for Terraform that provides extra tools for working with multiple Terraform modules. It is not a replacement for Terraform, but rather a tool to help you work with Terraform more effectively with DRY (Don't Repeat Yourself) principles.
...
Example [examples/terraform_data](examples/terraform_data)
